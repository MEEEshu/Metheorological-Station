...
# button for voltage - channel 0
buton0 = Button(grafic, text="Temperatură - istoric", command=functieTemp, padx=25, pady=5).grid(row=0, column=0)

# button for voltage - channel 1
# buton pentru functia aflarii tensiunii - canal 1
buton1 = Button(grafic, text="Umiditate - istoric", command=functieUmiditate, padx=25, pady=5).grid(row=1, column=0)

# button for voltage - channel 2
# buton pentru functia aflarii tensiunii - canal 2
buton2 = Button(grafic, text="Istoric total", command=functieToate, padx=25, pady=5).grid(row=0, column=1)

# button for voltage - channel 3
# buton pentru functia aflarii tensiunii - canal 3
buton3 = Button(grafic, text=" Viteză vânt- istoric", command=functieVitezaVant, padx=25, pady=5).grid(row=1, column=1)


#plt.plot(1,x)
#ax1.legend('upper left')
#ax2.legend('center')
#ax3.legend('lower right')
